...
class UsersTableSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'cashier1', 'email' => 'jane.smith@repairo.com', 'phone' => '081500000002', 'role' => 'cashier', 'password' => Hash::make('password')],
            ['name' => 'Michael Brown', 'email' => 'michael.brown@repairo.com', 'phone' => '081500000003', 'role' => 'admin', 'password' => Hash::make('password')],
