...
class RepairsTableSeeder extends Seeder
{
    public function run(): void
    {
        $repairs = [
            ...
            ['customer_name'=>null,'phone'=>null,'phone_brand'=>'Oppo','phone_model'=>'Reno 8','imei'=>'233456789012345','complaint'=>'Water damage','status'=>'finished','technician'=>'technician3','sparepart'=>'Motherboard','diagnosis'=>'Shorted due to liquid','cost'=>3500000,'technician_id'=>3],
            ['customer_name'=>null,'phone'=>null,'phone_brand'=>'Vivo','phone_model'=>'V25','imei'=>'333456789012345','complaint'=>'Display not turning on','status'=>'finished','technician'=>'technician1','sparepart'=>'Display Unit','diagnosis'=>'Display power line failure','cost'=>2100000,'technician_id'=>1],
        ];
