...
class RepairsTableSeeder extends Seeder
{
    public function run(): void
    {
        $repairs = [
            ...
            ['customer_name'=>"Zack Alan",'phone'=>'','phone_brand'=>'Oppo','phone_model'=>'Reno 8','imei'=>'233456789012345','complaint'=>'Water damage','status'=>'finished','technician'=>'technician3','sparepart'=>'Motherboard','diagnosis'=>'Shorted due to liquid','cost'=>3500000,'technician_id'=>3],
