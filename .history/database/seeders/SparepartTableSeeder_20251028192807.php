...
class SparepartTableSeeder extends Seeder
{
    public function run(): void
    {
            ...
            foreach ($models as $model) {
                foreach ($parts as $part) {
                    ...
                    $price = match ($category) {
                        'Original' => rand(10, 50) * 50000,       // 500rb–2.5jt
                        'OEM' => rand(6, 36) * 50000,             // 300rb–1.8jt
                        'Aftermarket' => rand(2, 20) * 50000,     // 100rb–1jt
                        'Replica' => rand(1, 10) * 50000,         // 50rb–500rb
                    };
        ...
        $this->command->info('✅ SparepartTableSeeder sukses! Data lengkap semua seri HP sudah di-seed ulang.');
    }
}