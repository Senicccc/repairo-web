...
class RepairsTableSeeder extends Seeder
{
    public function run(): void
    {
        $repairs = [
            ...
            ['customer_name'=>"Jeremy Jenner",'phone'=>null,'phone_brand'=>'Vivo','phone_model'=>'V25','imei'=>'333456789012345','complaint'=>'Display not turning on','status'=>'finished','technician'=>'technician1','sparepart'=>'Display Unit','diagnosis'=>'Display power line failure','cost'=>2100000,'technician_id'=>1],
        ];
