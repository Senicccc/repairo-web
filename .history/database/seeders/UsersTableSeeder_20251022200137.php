...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        $users = [
            // Staff
            ['name' => 'John Smith', 'phone' => '081234567890', 'email' => 'tech1@repairo.com', 'password' => Hash::make('12345678'), 'role' => 'technician'],
            ['name' => 'Alice Brown', 'phone' => '081345678901', 'email' => 'cashier1@repairo.com', 'password' => Hash::make('12345678'), 'role' => 'cashier'],
            ['name' => 'Michael Davis', 'phone' => '081456789012', 'email' => 'admin1@repairo.com', 'password' => Hash::make('12345678'), 'role' => 'admin'],
