...
class UsersTableSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'technician2', 'email' => 'technician2@repairo.com', 'phone' => '081500000001', 'role' => 'technician', 'password' => Hash::make('password')],
            ['name' => 'technician3', 'email' => 'technician1@repairo.com', 'phone' => '081500000001', 'role' => 'technician', 'password' => Hash::make('password')],
