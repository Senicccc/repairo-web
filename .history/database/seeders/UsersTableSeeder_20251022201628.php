...
class UsersTableSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            // Staff
            ['name' => 'technician1', 'email' => 'john.doe@repairo.com', 'phone' => '081500000001', 'role' => 'staff', 'password' => Hash::make('password')],
            ['name' => 'Jane Smith', 'email' => 'jane.smith@repairo.com', 'phone' => '081500000002', 'role' => 'staff', 'password' => Hash::make('password')],
