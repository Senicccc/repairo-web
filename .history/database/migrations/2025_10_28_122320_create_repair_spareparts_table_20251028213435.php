...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('repair_spareparts', function (Blueprint $table) {
            ...
            $table->string('model')->nullable(); // Untuk menyimpan model (jika sparepart_id null)
            $table->string('category')->nullable(); // Untuk menyimpan kategori (jika sparepart_id null)
