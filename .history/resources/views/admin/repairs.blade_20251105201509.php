...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('DOM loaded, repairs table initialized');
console.log('Total rows:', document.querySelectorAll('#repairsTableBody tr').length);
console.log('Edit buttons:', document.querySelectorAll('.edit-repair').length);
console.log('Delete buttons:', document.querySelectorAll('.delete-repair').length);
