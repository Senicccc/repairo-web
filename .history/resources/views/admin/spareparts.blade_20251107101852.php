...
<div class="mt-4 flex items-center justify-between">
    <div class="text-sm text-gray-600">
        Showing {{ $spareparts->firstItem() ?? 0 }} to {{ $spareparts->lastItem() ?? 0 }} of {{ number_format($spareparts->total()) }} items
    </div>
    <div class="flex space-x-2">
        ...
        @else
            <button onclick="loadSparepartsPage('{{ $spareparts->previousPageUrl() }}')" class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition duration-200">
                Previous
            </button>
        @endif

        @if ($spareparts->hasMorePages())
            <button onclick="loadSparepartsPage('{{ $spareparts->nextPageUrl() }}')" class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition duration-200">
                Next
            </button>
        @else
            <span class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-400 bg-gray-100 cursor-not-allowed">
