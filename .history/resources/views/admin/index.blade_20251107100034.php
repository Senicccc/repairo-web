...
function openSparepartEditModal(sparepartId, row) {
    ...
    const currentModel = modelsCell.textContent.trim() === '-' ? '' : modelsCell.textContent.trim(); // Ambil dari kolom "Compatible Devices"
    ...
    document.getElementById('editSparepartModel').value = currentModel; // TAMBAH INI
...
document.getElementById('createSparepartForm')?.addEventListener('submit', async function(e) {
    ...
    const formData = {
        ...
        model: document.getElementById('editSparepartModel').value,compatible_models: document.getElementById('createSparepartModels').value,
