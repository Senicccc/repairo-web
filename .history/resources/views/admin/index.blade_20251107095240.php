    ...
    <div class="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <form id="editSparepartForm">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="editSparepartModels" name="model" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="iPhone 12, Samsung S21, etc (comma separated)">
            </div>
...
<div id="createSparepartModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <form id="createSparepartForm">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Compatible Models</label>
                <input type="text" id="createSparepartModels" name="model" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="iPhone 12, Samsung S21, etc (comma separated)">
            </div>
...
<div id="createSparepartModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <form id="createSparepartForm">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Compatible Models</label>
                <input type="text" id="createSparepartModels" name="models" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="iPhone 12, Samsung S21, etc (comma separated)">
            </div>
