    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
        ...
        <form id="userForm">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="user_name" class="w-full border border-gray-300 rounded-lg p-2.5">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Email</label>
                <input type="email" id="user_email" class="w-full border border-gray-300 rounded-lg p-2.5">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Phone</label>
                <input type="text" id="user_phone" class="w-full border border-gray-300 rounded-lg p-2.5">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Role</label>
                <select id="user_role" class="w-full border border-gray-300 rounded-lg p-2.5">
            ...
            <div class="mb-6">
                ...
                <input type="password" id="user_password" class="w-full border border-gray-300 rounded-lg p-2.5">
            </div>
