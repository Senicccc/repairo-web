<section id="repairs" class="tab-section">
    ...
    <div class="mb-4">
        <input type="text" placeholder="Search repairs..." class="border border-gray-300 px-4 py-2 rounded-lg w-1/2 search" data-table="repairs">
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900">{{ $repair->tracking_id }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $repair->technician ?? '-' }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
