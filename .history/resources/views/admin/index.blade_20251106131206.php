    ...
    <div class="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <form id="editSparepartForm">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="editSparepartModels" name="compatible_models" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="iPhone 12, Samsung S21, etc (comma separated)">
            </div>
...
function openSparepartEditModal(sparepartId, row) {
    ...
    const currentCategory = categoryCell.textContent.trim().toLowerCase().replace(/\s+/g, '_') || 'other';
