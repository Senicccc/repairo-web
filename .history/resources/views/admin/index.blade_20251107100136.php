...
function openSparepartEditModal(sparepartId, row) {
    ...
    const currentModel = modelsCell.textContent.trim() === '-' ? '' : modelsCell.textContent.trim();
...
document.getElementById('editSparepartForm')?.addEventListener('submit', async function(e) {
    ...
    const formData = {
        ...
        model: document.getElementById('editSparepartModel').value, // TAMBAH INI
...
document.getElementById('createSparepartForm')?.addEventListener('submit', async function(e) {
    ...
    const formData = {
        ...
        model: document.getElementById('createSparepartModel').value, // TAMBAH INI
