<x-guest-layout>
    ...
    <div class="text-center mb-10">
        <img src="{{ asset('images/repairo-logo.png') }}" 
             alt="Repairo Logo" 
             class="w-48 h-48 mx-auto mb-4 drop-shadow-xl transition-transform duration-300 hover:scale-105">
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Welcome Back</h2>
        <p class="text-gray-500 mt-2 text-base sm:text-lg">Log in to continue managing your repairs effortlessly.</p>
    </div>
