...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    ...
    <table class="w-full text-sm border">
        ...
        <tr class="border-b">
            <td class="font-semibold p-2">Email Verified At</td>
            <td class="p-2">{{ $user->email_verified_at ?? '-' }}</td>
        </tr>
        <tr class="border-b">
            <td class="font-semibold p-2">Password (Hashed)</td>
            <td class="p-2 text-gray-500 break-all">{{ $user->password }}</td>
        </tr>
        <tr class="border-b">
            <td class="font-semibold p-2">Remember Token</td>
            <td class="p-2">{{ $user->remember_token ?? '-' }}</td>
        </tr>
        <tr class="border-b">
