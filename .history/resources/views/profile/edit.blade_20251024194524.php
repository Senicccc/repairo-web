...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    ...
    <form method="POST" action="{{ route('profile.update') }}">
        ...
        <div class="mb-3">
            <label class="block mb-1 font-semibold">Email Verified At</label>
            <input type="text" name="email_verified_at" value="{{ old('email_verified_at', $user->email_verified_at) }}" class="w-full border rounded p-2">
        </div>

        <div class="mb-3">
            <label class="block mb-1 font-semibold">Password (Hashed)</label>
            <input type="text" name="password" value="{{ old('password', $user->password) }}" class="w-full border rounded p-2">
        </div>

        <div class="mb-3">
            <label class="block mb-1 font-semibold">Remember Token</label>
            <input type="text" name="remember_token" value="{{ old('remember_token', $user->remember_token) }}" class="w-full border rounded p-2">
        </div>
