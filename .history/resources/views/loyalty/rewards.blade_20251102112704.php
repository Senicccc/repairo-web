...
<div class="max-w-5xl mx-auto p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="border rounded shadow hover:shadow-lg p-4 flex flex-col justify-between">
            ...
            <button class="mt-4 bg-green-500 hover:bg-green-600 text-white py-2 rounded font-semibold open-modal @if(auth()->user()->loyalty_points < $r['points']) opacity-50 cursor-not-allowed @endif"
