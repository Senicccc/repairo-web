...
<div class="max-w-5xl mx-auto p-6 space-y-6">
    ...
    <h3 class="text-2xl font-semibold mt-8 mb-4">Note: if the status is "claimed" that means you just claimed it and have not use it to the cashier and if its "used then you have redeem it </h3>
