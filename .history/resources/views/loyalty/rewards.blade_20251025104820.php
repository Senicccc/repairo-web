...
<div id="claimModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded shadow-lg w-96 p-6 relative">
        ...
        <div class="space-y-2">
            ...
            <p>Discount: Rp<span id="modalDiscount" class="font-bold"></span></p>
            <p>Gift 1: <span id="modalGift1" class="font-bold"></span></p>
            <p>Gift 2: <span id="modalGift2" class="font-bold"></span></p>
        </div>
        <form id="modalForm" action="{{ route('loyalty.claim') }}" method="POST" class="mt-4">
            @csrf
...
document.addEventListener('click', function(e){
    ...
    if(e.target && e.target.classList.contains('open-modal')){
        ...
        document.getElementById('modalGift1').innerText = btn.dataset.gift1;
        document.getElementById('modalGift2').innerText = btn.dataset.gift2;
