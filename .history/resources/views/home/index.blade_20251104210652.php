...
<div class="bg-white text-gray-800">
    ...
    {{-- HERO SECTION --}}
    <section class="bg-[#0A4D9E] text-white py-20">
        <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="flex-1">
                <img src="https://images.unsplash.com/photo-1605902711622-cfb43c4437e0?auto=format&fit=crop&w=900&q=80"
                     alt="Phone Repair" class="rounded-2xl shadow-xl w-full">
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6 text-center">
            <h2 class="text-3xl font-bold text-[#0A4D9E] mb-4">About Repairo</h2>
        ...
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <div class="mt-10">
                <a href="{{ route('repairs.create') }}" 
                   class="inline-block bg-[#0A4D9E] text-white px-8 py-3 rounded-lg font-semibold shadow hover:bg-blue-800 transition">
                    Book a Repair Now
                </a>
            </div>
        </div>
