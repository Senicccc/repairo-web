<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm">
    ...
    <div class="px-4 pt-4 pb-3 space-y-1">
      ...
      @guest
        <div class="pt-3 border-t border-gray-100">
          <a href="{{ route('login') }}" class="block text-sm px-3 py-2 rounded-md text-[#1800AD] font-medium hover:bg-indigo-50 transition">
            Log in
          </a>
          <a href="{{ route('register') }}" class="block text-sm px-3 py-2 rounded-md text-white bg-[#1800AD] font-medium hover:bg-[#16009d] transition">
            Register
          </a>
        </div>
      @endguest
