                    ...
                    <tr class="text-center hover:bg-gray-50 transition border-b"
                        ...
                        <td class="border px-3 py-2">
                            @if($repair->status === 'finished' && $repair->cost && $repair->cost > 0)
                                <a href="{{ route('cashier.loyalty.redeem.repair', $repair->id) }}"
                                    class="bg-yellow-500 text-white px-2 py-1 rounded text-xs hover:bg-yellow-600 transition inline-block">
                                    Redeem
                                </a>
                            @endif
                        </td>
