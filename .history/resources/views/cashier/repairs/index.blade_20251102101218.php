                ...
                <tbody>
                    ...
                    <tr class="text-center hover:bg-gray-50 transition border-b">
                        ...
                        <td class="border px-3 py-2">
                            <div class="text-sm font-medium">{{ $repair->user->name ?? $repair->customer_name ?? '-' }}</div>
                            <div class="text-xs text-gray-500">{{ $repair->phone ?? '-' }}</div>
                        </td>
                        <td class="border px-3 py-2">
                            {{ $repair->phone_brand }} {{ $repair->phone_model }}
                        </td>
                        <td class="border px-3 py-2 text-left max-w-xs truncate">
                            {{ Str::limit($repair->complaint, 50) }}
                        </td>
...
<!-- Include Modals dari dashboard -->
@include('cashier.modals.create-repair')
@include('cashier.modals.payment')
