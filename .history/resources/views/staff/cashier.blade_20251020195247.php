...
<dialog id="addRepairModal" class="modal">
    <form method="POST" action="{{ route('repairs.store') }}" class="p-6 bg-white rounded shadow-md w-[480px] mx-auto">
        ...
        <!-- Customer Selection -->
        <select name="user_id" class="w-full border p-2 mb-3 rounded" required>
        ...
        <!-- Technician & Cost -->
        <input type="text" name="technician" placeholder="Technician Name" class="w-full border p-2 mb-3 rounded">
...
<script>
    /**
     * Open payment modal and prefill amount
     * based on selected repair record
     */
