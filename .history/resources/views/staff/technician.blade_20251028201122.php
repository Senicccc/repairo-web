...
<dialog id="jobModal" class="modal">
    <form method="POST" id="jobForm" class="p-6 bg-white rounded shadow-md w-[480px] mx-auto">
        ...
        <label class="block mb-2 text-sm font-medium">Sparepart</label>
        <input type="text" id="sparepartSearch" placeholder="Cari sparepart..." class="w-full border p-2 mb-2 rounded">
        <select id="sparepartList" size="4" class="w-full border p-2 mb-3 rounded">
            <option value="Baterai">Baterai</option>
            <option value="Kamera">Kamera</option>
            <option value="Layar">Layar</option>
            <option value="Back Cover">Back Cover</option>
            <option value="Speaker">Speaker</option>
            <option value="Port Charger">Port Charger</option>
        </select>
        <textarea name="sparepart" placeholder="Atau ketik manual sparepart..." class="w-full border p-2 mb-3 rounded"></textarea>
