...
<div class="flex">
    ...
    <aside class="w-1/5 bg-gray-900 text-white min-h-screen p-4">
        ...
        <ul>
            ...
            <li>
                <a href="#spareparts" class="block py-2 px-3 hover:bg-gray-700 rounded mb-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                            <div>
                                <p class="font-medium text-sm">{{ $repair->tracking_id }}</p>
                                <p class="text-xs text-gray-600">{{ $repair->phone_brand }} {{ $repair->phone_model }}</p>
                            </div>
                            <span class="{{ \App\Models\Repair::getStatusColor($repair->status) }} px-2 py-1 rounded text-xs">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                            <div>
                                <p class="font-medium text-sm">Rp {{ number_format($payment->amount, 0, ',', '.') }}</p>
                                <p class="text-xs text-gray-600">{{ $payment->payment_method }} • {{ $payment->repair->tracking_id ?? 'N/A' }}</p>
                            </div>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-blue-700">{{ $repair->tracking_id }}</td>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">{{ $payment->repair->user->name ?? $payment->repair->customer_name }}</td>
                            <td class="px-4 py-3">{{ $payment->repair->tracking_id }}</td>
                            <td class="px-4 py-3">
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 font-medium">{{ $reward->reward_name }}</td>
                            <td class="px-4 py-3">{{ $reward->description ?? '-' }}</td>
                            <td class="px-4 py-3">{{ $reward->points_required }}</td>
                            <td class="px-4 py-3 font-mono">{{ $reward->code }}</td>
                            <td class="px-4 py-3">
                                <span class="px-2 py-1 rounded text-xs 
