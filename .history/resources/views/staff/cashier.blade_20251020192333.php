        ...
        <table class="min-w-full border border-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2 border">Damage Description</th>
...
<dialog id="addRepairModal" class="modal">
    <form method="POST" action="{{ route('repairs.store') }}" class="p-6 bg-white rounded shadow-md w-[500px] mx-auto">
        ...
        <input type="text" name="phone" placeholder="Customer Phone Number" class="w-full border p-2 mb-3 rounded">
        <input type="text" name="device_type" placeholder="Device Type" class="w-full border p-2 mb-3 rounded">
        <input type="text" name="brand" placeholder="Brand" class="w-full border p-2 mb-3 rounded">
        <input type="text" name="model" placeholder="Model" class="w-full border p-2 mb-3 rounded">
        <textarea name="damage_description" placeholder="Damage Description" class="w-full border p-2 mb-3 rounded"></textarea>
