...
document.getElementById('jobForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        console.log('Updating repair with data:', {
        ...
        if (pendingSpareparts.length > 0) {
            console.log('Adding spareparts:', pendingSpareparts);
            
            for (const it of pendingSpareparts) {
                // PASTIKAN SEMUA FIELD DIKIRIM - TERMASUK NAME DAN CATEGORY
                const sparepartData = new URLSearchParams();
                sparepartData.append('name', it.name || ''); // HARUS ADA
                ...
                sparepartData.append('category', it.category || ''); // Juga kirim category
                ...
                try {
                    ...
                    console.error('Error adding sparepart:', sparepartErr);
                    alert('Error adding sparepart: ' + sparepartErr.message);
                }
            }
        }
