            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Here's your repair request history and loyalty points summary.</p>
                    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $statusColors = [
                                            ...
                                            'waiting_for_spareparts' => 'bg-orange-100 text-orange-800'
                                        ];
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('repairs.show', $repair->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                    @if($repair->status === 'finished')
                                        <a href="{{ route('repairs.invoice', $repair->id) }}" class="text-green-600 hover:text-green-900">Invoice</a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
