...
class AdminController extends Controller
{
    ...
    // Load sections dynamically - PERBAIKAN
    public function getSection($section)
    {
        ...
        // Jika request AJAX (untuk pagination), return hanya HTML-nya
        if (request()->ajax()) {
    ...
    // Search function untuk semua section - PERBAIKAN
    public function search($section)
    {
        ...
        // Set view berdasarkan section
        $view = "admin.{$section}";

        // Jika request AJAX, return HTML saja
        if (request()->ajax()) {
            return view($view, $data)->render();
        }
    ...
    // HAPUS METHOD YANG DUPLIKAT - method berikut sudah ada di getSection()
