...
class HomeController extends Controller
{
    ...
    {
        // PERBAIKAN: Redirect ke AdminController atau gunakan view admin yang baru
        return redirect()->route('admin.dashboard');
        
        // ATAU jika ingin langsung load data di sini:
        // $users = User::all();
        // $repairs = Repair::with('user')->get();
        // $payments = Payment::with('repair.user')->get();
        // $rewards = LoyaltyReward::with('user')->get();
        // return view('admin.index', compact('users', 'repairs', 'payments', 'rewards'));
    }
