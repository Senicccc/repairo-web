...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // ✅ Bedain redirect berdasarkan role yang login
        $redirectRoute = match (auth()->user()->role ?? 'guest') {
            'admin'   => 'admin.users',          // ke halaman daftar user admin
            'cashier' => 'cashier.users.index',  // ke daftar user cashier (foldernya memang ada)
            default   => 'home',                 // fallback aman
        };
