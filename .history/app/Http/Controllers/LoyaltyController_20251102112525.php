...
class LoyaltyController extends Controller
{
    ...
    public function showRewards()
    {
        ...
        // PERBAIKAN: Discount dalam Rupiah penuh, bukan dikali 1000
        $rewardOptions = [
            ['points' => 50, 'discount' => 20000, 'gift1' => 'Charging Cable', 'gift2' => 'Cleaning Kit'],
            ['points' => 100, 'discount' => 50000, 'gift1' => 'Earphones', 'gift2' => 'Mini Powerbank'],
            ['points' => 150, 'discount' => 90000, 'gift1' => 'Smartphone Stand', 'gift2' => 'Wireless Mouse'],
            ['points' => 200, 'discount' => 130000, 'gift1' => 'Bluetooth Speaker', 'gift2' => 'Headset'],
            ['points' => 250, 'discount' => 180000, 'gift1' => 'Wireless Charger', 'gift2' => 'Portable Speaker'],
            ['points' => 300, 'discount' => 230000, 'gift1' => 'Smartwatch', 'gift2' => 'Noise Cancelling Headphones'],
            ['points' => 400, 'discount' => 300000, 'gift1' => 'Tablet Stand', 'gift2' => 'Mini Projector'],
            ['points' => 500, 'discount' => 400000, 'gift1' => 'VR Glasses', 'gift2' => 'Bluetooth Keyboard'],
        ];

        $recentRewards = $user->loyaltyRewards()->latest()->take(10)->get();

        return view('loyalty.rewards', compact('points', 'rewardOptions', 'recentRewards'));
    }
    ...
    public function claimReward(Request $request)
    {
        ...
        if ($request->reward_type === 'discount') {
            $rewardType = 'discount';
            $rewardValue = (int) $request->discount; // Sudah dalam Rupiah penuh
        } else {
            $rewardType = 'gift';
            // Tentukan hadiah mana yang dipilih
            $rewardValue = $request->reward_type === 'gift1' ? $request->gift1 : $request->gift2;
        }
