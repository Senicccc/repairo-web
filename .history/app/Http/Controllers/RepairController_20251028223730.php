...
class RepairController extends Controller
{
    ...
    public function addSparepart(Request $request, $id)
    {
        ...
        try {
            ...
            // CEK DUPLIKAT - jika sparepart_id sama dan source sama
            ...
            // BUAT BARU jika tidak ada duplikat
    ...
    public function removeSparepart($repairId, $sparepartId)
    {
        ...
        try {
            ...
            // KEMBALIKAN STOCK jika in_store
