...
class LoyaltyController extends Controller
{
    ...
    public function showRewards()
    {
        ...
        $rewardOptions = [
            ...
            ['points' => 100, 'discount' => 50000, 'gift1' => 'Earphone', 'gift2' => 'Mini Powerbank'],
            ['points' => 150, 'discount' => 90000, 'gift1' => 'Voucher Rp50.000', 'gift2' => 'Premium Phone'],
            ['points' => 200, 'discount' => 130000, 'gift1' => 'Voucher Rp100.000', 'gift2' => 'Headset/ Speaker'],
        ];
    ...
    public function claimReward(Request $request)
    {
        ...
        if ($user->loyalty_points < $pointsNeeded) {
            return back()->with('error', 'Points not sufficient.');
        }
