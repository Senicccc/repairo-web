...
class AdminController extends Controller
{
    ...
    {
        $data = [
            'users' => User::paginate(10), // TAMBAH PAGINATION
            'repairs' => Repair::with(['user', 'payment'])->paginate(10), // TAMBAH PAGINATION
            'payments' => Payment::with(['repair.user'])->paginate(10), // TAMBAH PAGINATION
            'rewards' => LoyaltyReward::with('user')->paginate(10), // TAMBAH PAGINATION
            'spareparts' => Sparepart::paginate(10), // TAMBAH PAGINATION
        ];
