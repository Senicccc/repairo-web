...
class RepairController extends Controller
{
    ...
    // Update job (diagnosis, cost, status) oleh teknisi
    ...
    // Update field sparepart di tabel repairs
    private function updateRepairSparepartField(Repair $repair)
    {
        $sparepartsList = \App\Models\RepairSparepart::where('repair_id', $repair->id)
            ->pluck('name')
            ->toArray();
