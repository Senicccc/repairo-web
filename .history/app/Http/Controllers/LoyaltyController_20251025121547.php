...
class LoyaltyController extends Controller
{
    ...
    // Klaim reward (fix: redeem_code tersimpan)
    public function claimReward(Request $request)
    {
        ...
        // Generate kode unik dan pastikan belum pernah dipakai
        do {
        ...
        // Simpan ke database termasuk redeem_code (FIXED)
    ...
    // Konfirmasi penukaran reward di kasir
    ...
    // Redeem code langsung (aplikasi diskon/gift ke repair)
