...
class AdminController extends Controller
{
    ...
    // Update Payment
// Update Payment method - PERBAIKI INI
public function updatePayment(Request $request, $id)
{
    try {
        ...
        $data = $request->validate([
            'status' => 'required|string|in:unpaid,paid', // SESUAIKAN DENGAN DATABASE
            'payment_method' => 'required|string|in:cash,transfer,ewallet', // SESUAIKAN DENGAN DATABASE
