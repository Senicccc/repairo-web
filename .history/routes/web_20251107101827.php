...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::post('/spareparts', [AdminController::class, 'storeSparepart'])->name('admin.spareparts.store'); // GUNAKAN storeSparepart, BUKAN createSparepart
    Route::put('/spareparts/{id}', [AdminController::class, 'updateSparepart'])->name('admin.spareparts.update');
    Route::delete('/spareparts/{id}', [AdminController::class, 'deleteSparepart'])->name('admin.spareparts.destroy');
        Route::get('/section/{section}', [AdminController::class, 'getSection'])->name('admin.section');
    
    // Spareparts pagination khusus
    Route::get('/spareparts/page', [AdminController::class, 'sparepartsPage'])->name('admin.spareparts.page');
});
