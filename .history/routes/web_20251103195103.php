// Update job oleh teknisi via RepairController
Route::middleware(['auth', 'role:technician'])->post('/repairs/{id}/update-job', [RepairController::class, 'updateJob'])->name('repairs.updateJob');
<?php
