...
// Loyalty Routes
Route::middleware(['auth'])->group(function () {
    Route::get('/loyalty/rewards', [LoyaltyController::class, 'showRewards'])->name('loyalty.rewards');
    Route::post('/loyalty/claim', [LoyaltyController::class, 'claimReward'])->name('loyalty.claim');
});

// Cashier Routes
Route::middleware(['auth'])->group(function () {
    Route::get('/cashier/loyalty/redeem', [LoyaltyController::class, 'redeemPage'])->name('cashier.loyalty.redeem');
    Route::post('/cashier/loyalty/check', [LoyaltyController::class, 'check'])->name('cashier.loyalty.check');
    Route::post('/cashier/loyalty/confirm', [LoyaltyController::class, 'confirmClaim'])->name('cashier.loyalty.confirm');
});
