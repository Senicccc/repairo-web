...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/user/repairs/history', [UserDashboardController::class, 'repairHistory'])->name('repairs.history');
    Route::get('/user/repairs/{id}', [UserDashboardController::class, 'showRepair'])->name('repairs.show');
