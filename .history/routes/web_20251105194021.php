...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Repair Management (Admin)
    Route::get('/repairs', [RepairController::class, 'adminIndex'])->name('admin.repairs.index'); // list
    Route::post('/repairs', [RepairController::class, 'store'])->name('admin.repairs.store');      // optional create
    Route::put('/repairs/{id}', [AdminController::class, 'updateRepair'])->name('admin.repairs.update'); // update
    Route::delete('/repairs/{id}', [AdminController::class, 'deleteRepair'])->name('admin.repairs.destroy'); // delete
});
