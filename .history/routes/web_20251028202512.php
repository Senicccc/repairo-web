...
// sparepart search API (AJAX)
Route::get('/spareparts/search', [App\Http\Controllers\SparepartController::class, 'search'])
    ->middleware(['auth', 'role:technician'])->name('spareparts.search');

// tambah sparepart ke repair
Route::post('/repairs/{id}/spareparts', [App\Http\Controllers\RepairController::class, 'addSparepart'])
    ->middleware(['auth', 'role:technician'])->name('repairs.addSparepart');
